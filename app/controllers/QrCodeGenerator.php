...
class QrCodeGenerator extends Controller {
    ...
    public function index() {
        ...
        if($_POST['custom_eyes_color']) {
            $_POST['eyes_inner_color'] = !verify_hex_color($_POST['eyes_inner_color']) ? null : $_POST['eyes_inner_color'];
            $_POST['eyes_outer_color'] = !verify_hex_color($_POST['eyes_outer_color']) ? null : $_POST['eyes_outer_color'];
        }
...
//                    }
        ...
        if($frame) {
            ...
            if($_POST['frame_custom_colors']) {
                $_POST['frame_color'] = !verify_hex_color($_POST['frame_color']) ? null : $_POST['frame_color'];
                $_POST['frame_text_color'] = !verify_hex_color($_POST['frame_text_color']) ? null : $_POST['frame_text_color'];
            }
