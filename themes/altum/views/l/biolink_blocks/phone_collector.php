                ...
                <form id="<?= 'phone_collector_form_' . $data->link->biolink_block_id ?>" method="post" role="form">
                    ...
                    <?php if($data->link->settings->show_agreement): ?>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" id="<?= 'phone_collector_agreement_' . $data->link->biolink_block_id ?>" name="agreement" class="custom-control-input" required="required" />
                            <label class="custom-control-label font-weight-normal" for="<?= 'phone_collector_agreement_' . $data->link->biolink_block_id ?>">
