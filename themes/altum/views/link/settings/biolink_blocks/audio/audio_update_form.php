...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="<?= 'audio_file_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-file fa-sm text-muted mr-1"></i> <?= l('biolink_file.file') ?></label>
        <div class="row">
            <div class="col">
    ...
    <div class="form-group">
        <label for="<?= 'audio_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'audio_autoplay_' . $row->biolink_block_id ?>"><?= l('biolink_audio.audio_autoplay') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'audio_controls_' . $row->biolink_block_id ?>"><?= l('biolink_audio.audio_controls') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'audio_loop_' . $row->biolink_block_id ?>"><?= l('biolink_audio.audio_loop') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'audio_muted_' . $row->biolink_block_id ?>"><?= l('biolink_audio.audio_muted') ?></label>
    </div>
