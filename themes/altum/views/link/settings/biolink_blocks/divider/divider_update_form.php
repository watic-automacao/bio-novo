...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group" data-range-counter>
        <label for="<?= 'divider_margin_top' . $row->biolink_block_id ?>"><?= l('biolink_divider.margin_top') ?></label>
    ...
    <div class="form-group" data-range-counter>
        <label for="<?= 'divider_margin_bottom' . $row->biolink_block_id ?>"><?= l('biolink_divider.margin_bottom') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'divider_background_color' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
