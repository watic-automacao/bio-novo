...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
        ...
        <?php foreach($row->settings->items as $key => $item): ?>
            <div class="mb-4">
                <div class="form-group">
                    <label for="<?= 'item_title_' . $key . '_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_timeline.title') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'item_description_' . $key . '_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-pen fa-sm text-muted mr-1"></i> <?= l('biolink_link.description') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'item_date_' . $key . '_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-calendar fa-sm text-muted mr-1"></i> <?= l('biolink_timeline.date') ?></label>
    ...
    <div class="mb-3">
        <button data-add="timeline_item" data-biolink-block-id="<?= $row->biolink_block_id ?>" type="button" class="btn btn-outline-success btn-block"><i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('global.create') ?></button>
    </div>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'timeline_title_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_timeline.title_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'timeline_description_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.description_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'timeline_date_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_timeline.date_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'timeline_line_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_timeline.line_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'timeline_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
