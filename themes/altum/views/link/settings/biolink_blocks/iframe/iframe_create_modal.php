...
<div class="modal fade" id="create_biolink_iframe" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_iframe.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_iframe" method="post" role="form" enctype="multipart/form-data">
