    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_service.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_service" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="service_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
