...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group">
        <label for="<?= 'list_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_list.text') ?></label>
        <textarea id="<?= 'list_text_' . $row->biolink_block_id ?>" class="form-control" name="text" maxlength="10000"><?= $row->settings->text ?></textarea>
        <small class="form-text text-muted"><?= l('biolink_list.text_help') ?></small>
    </div>
    ...
    <div class="form-group">
        <label for="<?= 'margin_items_y' . $row->biolink_block_id ?>"><?= l('biolink_list.margin_items_y') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'margin_items_x' . $row->biolink_block_id ?>"><?= l('biolink_list.margin_items_x') ?></label>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'list_text_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.text_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'list_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
