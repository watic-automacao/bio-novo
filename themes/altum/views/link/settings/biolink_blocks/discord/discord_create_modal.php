    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_discord.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_discord" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="discord_server_id"><i class="fab fa-fw fa-discord fa-sm text-muted mr-1"></i> <?= l('biolink_discord.server_id') ?></label>
