    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_twitch.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_twitch" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="twitch_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_twitch.location_url') ?></label>
                        <input id="twitch_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('biolink_twitch.location_url_placeholder') ?>" />
                    </div>
