    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_anchor.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_anchor" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="anchor_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_anchor.location_url') ?></label>
                        <input id="anchor_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('biolink_anchor.location_url_placeholder') ?>" />
                    </div>
