    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_file.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_file" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="file_file"><i class="fas fa-fw fa-file fa-sm text-muted mr-1"></i> <?= l('biolink_file.file') ?></label>
                    ...
                    <div class="form-group">
                        <label for="file_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
