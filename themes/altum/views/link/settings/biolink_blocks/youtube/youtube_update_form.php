...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group">
        <label for="<?= 'youtube_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_youtube.location_url') ?></label>
        <input id="<?= 'youtube_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="2048" placeholder="<?= l('biolink_youtube.location_url_placeholder') ?>" required="required" />
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        <input
                ...
                id="<?= 'youtube_autoplay_' . $row->biolink_block_id ?>"
                name="video_autoplay"
            <?= $row->settings->video_autoplay ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'youtube_autoplay_' . $row->biolink_block_id ?>"><?= l('biolink_video.video_autoplay') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        <input
                type="checkbox"
                class="custom-control-input"
                id="<?= 'youtube_controls_' . $row->biolink_block_id ?>"
                name="video_controls"
            <?= $row->settings->video_controls ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'youtube_controls_' . $row->biolink_block_id ?>"><?= l('biolink_video.video_controls') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        <input
                type="checkbox"
                class="custom-control-input"
                id="<?= 'youtube_loop_' . $row->biolink_block_id ?>"
                name="video_loop"
            <?= $row->settings->video_loop ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'youtube_loop_' . $row->biolink_block_id ?>"><?= l('biolink_video.video_loop') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        <input
                type="checkbox"
                class="custom-control-input"
                id="<?= 'youtube_muted_' . $row->biolink_block_id ?>"
                name="video_muted"
            <?= $row->settings->video_muted ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'youtube_muted_' . $row->biolink_block_id ?>"><?= l('biolink_video.video_muted') ?></label>
    </div>
