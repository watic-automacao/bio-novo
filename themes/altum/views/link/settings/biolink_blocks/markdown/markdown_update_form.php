...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group">
        <label for="<?= 'markdown_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_link.markdown_text') ?></label>
        <textarea id="<?= 'markdown_text_' . $row->biolink_block_id ?>" class="form-control" name="text" maxlength="10000"><?= $row->settings->text ?></textarea>
    ...
    <div class="form-group">
        <label for="<?= 'markdown_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
