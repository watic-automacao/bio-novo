    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_facebook.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_facebook" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="location_url"><i class="fab fa-fw fa-facebook fa-sm text-muted mr-1"></i> <?= l('biolink_facebook.location_url') ?></label>
                        <input id="location_url" type="url" class="form-control" name="location_url" required="required" />
                    </div>
