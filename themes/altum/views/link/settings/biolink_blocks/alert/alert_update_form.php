...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group">
        <label for="<?= 'alert_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_link.text') ?></label>
        <textarea id="<?= 'alert_text_' . $row->biolink_block_id ?>" class="form-control" name="text" maxlength="10000"><?= $row->settings->text ?></textarea>
    </div>
    ...
    <div class="form-group">
        <label for="<?= 'alert_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_link.location_url') ?></label>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="<?= 'alert_display_close_button_' . $row->biolink_block_id ?>"><?= l('biolink_alert.display_close_button') ?></label>
    </div>

    <div class="form-group">
        <label for="<?= 'alert_alert_pause_after_closed_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sort-numeric-up fa-sm text-muted mr-1"></i> <?= l('biolink_alert.alert_pause_after_closed') ?></label>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'alert_text_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.text_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'alert_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
