    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_alert.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_alert" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="alert_text"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_link.text') ?></label>
                        <textarea id="alert_text" class="form-control" name="text" maxlength="10000"></textarea>
                    </div>
